...
export function LocationsTable({
  ...
  const columns: DataTableColumn<LocationEntity>[] = [
    ...
    },
    {
      key: "type",
      header: "Tipo",
      cell: (row) => <LocationTypeBadge type={row.type} />,
    },
    {
      key: "contact",
      header: "Contacto",
  ...
  return (
    <>
      <DataTable<LocationEntity>
        ...
        emptyTitle="Aún no hay ubicaciones de inventario"
        emptyDescription="Crea la primera ubicación (ecommerce, sucursal o almacén) para empezar."
        meta={meta}
      ...
      <ConfirmDialog
        ...
        description={
          deleteTarget
            ? `«${deleteTarget.name}» y su stock asociado se eliminarán. Esta acción no se puede deshacer.`
            : undefined
        }
